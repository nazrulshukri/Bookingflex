...
app.post('/submit-payment', async (req, res) => {
  ...
  try {
    // Save payment information to the database or process payment
    // Example: await PaymentModel.create({ ...req.body });
    ...
    <p><strong>Outbound Flight:</strong> ${outboundFlight.flightNumber} (${outboundFlight.departure} to ${outboundFlight.arrival})</p>
...
const generatePDF = async (payment) => {
  return new Promise((resolve, reject) => {
    ...
    doc.text(`Ticket for Payment ID: ${payment._id}`);
